...
<section class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
  <div class="bg-white p-4 rounded shadow">
    <h2 class="font-semibold mb-3">Add Yarn Type</h2>
    <form method="post" class="space-y-3">
      <input type="hidden" name="action" value="yarn_type_add">
      <div>
        ...
        <tbody>
          <?php foreach ($rows as $r): ?>
            <tr class="border-t">
              ...
              <td class="py-2">
                <form method="post" onsubmit="return confirm('Delete this yarn type?');">
